...
function Navbar(){
    return(<>
        ...
        <div className="container-fluid">
          <a className="navbar-brand" href="#">🎨 EmpowerEd 🎨</a>
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li className="nav-item">
                <a className="nav-link" href="extras/about.html">About us ✨</a>
              </li>
              ...
              <li className="nav-item">
                <a className="nav-link" href="extras/contact.html">Contact Us 💬</a>
              </li>
            </ul>
