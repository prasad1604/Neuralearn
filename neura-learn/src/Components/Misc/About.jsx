        ...
        <div className="container my-4">
            ...
            <div className="row featurette d-flex justify-content-center align-items-center">
                ...
                <div className="col-md-7">
                    ...
                    >
                        Our Mission - <span className="text-muted">Making the future of autistic children better</span>
                    </h2>
                    ...
                    >
                        At NeuraLearn, our mission is to create a supportive and engaging learning environment tailored specifically for children with autism. 
                        ...
                        child can thrive, be understood, and be celebrated for their unique abilities.
                    </p>
                </div>
            ...
            <div className="row featurette d-flex justify-content-center align-items-center">
                ...
                <div className="col-md-7 order-md-2">
                    ...
                    >
                        Our story <span className="text-muted">We started NeuraLearn in 2024</span>
                    </h2>
                    ...
                    >
                        It all began with a simple question: How can we make learning more engaging and accessible for every child? As we delved into this question,
                        ...
                        all while making learning fun and rewarding.
                    </p>
                </div>
